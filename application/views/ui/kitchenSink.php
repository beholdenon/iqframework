<div class="row">
  <div class="columns">
    ...
    <ul class="small-block-grid-2 large-block-grid-4">
      <li><img class="th" src="<?php echo URL; ?>public/images/examples/comet-th.jpg"></li>
      <li><img class="th" src="<?php echo URL; ?>public/images/examples/launch-th.jpg"></li>
      <li><img class="th" src="<?php echo URL; ?>public/images/examples/space-th.jpg"></li>
      <li><img class="th" src="<?php echo URL; ?>public/images/examples/spacewalk-th.jpg"></li>
    </ul>
    ...
    <div>
      <div class="clearing-assembled"><div><a href="#" class="clearing-close">×</a><div class="visible-img" style="display: none"><div class="clearing-touch-label"></div><img src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" alt=""><p class="clearing-caption"></p><a href="#" class="clearing-main-prev"><span></span></a><a href="#" class="clearing-main-next"><span></span></a></div><div class="carousel"><ul class="clearing-thumbs" data-clearing="">
        ...
        <li><a class="th" href="<?php echo URL; ?>public/images/examples/earth.jpg"><img src="<?php echo URL; ?>public/images/examples/earth-th-sm.jpg"></a></li>
    
        <li><a class="th" href="<?php echo URL; ?>public/images/examples/launch.jpg"><img data-caption="Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus." src="<?php echo URL; ?>public/images/examples/launch-th-sm.jpg"></a></li>
    
        <li><a class="th" href="<?php echo URL; ?>public/images/examples/satelite.jpg"><img src="<?php echo URL; ?>public/images/examples/satelite-th-sm.jpg"></a></li>
    
        <li><a class="th" href="<?php echo URL; ?>public/images/examples/space.jpg"><img data-caption="Integer posuere erat a ante venenatis dapibus posuere velit aliquet." src="<?php echo URL; ?>public/images/examples/space-th-sm.jpg"></a></li>
      </ul></div></div></div>
    </div>
    ...
    <p><a class="button" data-dropdown="tinyDrop" href="#">Link Dropdown »</a>
      ...
      <div class="f-dropdown content medium" data-dropdown-content="" id="contentDrop">
        ...
        think is awesome! Some text that people will think is awesome!</p><img src="<?php echo URL; ?>public/images/examples/launch.jpg">
    ...
    <div class="row">
      <div class="large-12 columns">
        <div class="orbit-container"><ul id="featured1" data-orbit="" data-options="timer_speed:5000;" class="orbit-slides-container slide swipe-next" style="height: 240px;">
          <li class="animate-in" style="">
          ...
          <li style="" class="active animate-out">
        ...
        </ul><a href="#" class="orbit-prev"><span></span></a><a href="#" class="orbit-next"><span></span></a><div class="orbit-timer"><span></span><div class="orbit-progress" style="overflow: hidden; width: 3.8799999999999946%;"></div></div><div class="orbit-slide-number"><span>3</span> of <span>3</span></div><div class="orbit-bullets-container"><ol class="orbit-bullets"><li data-orbit-slide="0" class=""></li><li data-orbit-slide="1" class=""></li><li data-orbit-slide="2" class="active"></li></ol></div></div>
      </div>
    </div>
    ...
    <a href="#" data-reveal-id="videoModal" class="radius button">Example Modal w/Video…</a></p>
    <!-- Reveal Modals begin -->
    ...
    <div class="range-slider" data-slider="50">
        <span class="range-slider-handle" style="-webkit-transform: translateX(386px);"></span>
    ...
    <div class="range-slider" data-slider="40" data-options="step: 20;">
        <span class="range-slider-handle" style="-webkit-transform: translateX(308.6px);"></span>
    ...
    <p>The tooltips can be positioned on the <span data-tooltip="" class="has-tip" data-width="210" data-selector="tooltip-htmfhtmt0" title="">"tip-bottom"</span>, which is the default position, <span data-tooltip="" class="has-tip tip-top noradius" data-width="210" data-selector="tooltip-htmfhtmt1" title="">"tip-top" (hehe)</span>, <span data-tooltip="left" class="has-tip tip-left" data-width="90" title="">"tip-left"</span>, or <span data-tooltip="right" class="has-tip tip-right" data-width="120" title="">"tip-right"</span> of the target element by adding the appropriate class to them. You can even add your own custom class to style each tip differently. On a small device, the tooltips are full width and bottom aligned.</p>
    ...
    <p></p><dt>Definition List</dt><p></p>
    <p></p><h5>Definition lists are great for small block of copy that describe the header</h5><p></p>
    <p></p><dl><p></p>
    <p></p><dt>Lower cost
      </dt><dd>The new version of this product costs significantly less than the
    previous one!<p></p>
    <p></p></dd><dt>Easier to use
      </dt><dd>We've changed the product so that it's much easier to use!<p></p>
    <p></p></dd><dt>Safe for kids
      </dt><dd>You can leave your kids alone in a room with this product and
